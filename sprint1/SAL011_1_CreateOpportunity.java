...
public class SAL011_1_CreateOpportunity {
		...
		public static void main(String[] args) throws InterruptedException  {
			...
			driver.findElement(By.xpath("//span[text()='Select a date for Close Date']/following::input")).sendKeys("Salesforce Automation by Your Selvi");
	        ...
	        ((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView(); arguments[0].click();", stageSelect);//click on drop down
			...
			for (WebElement newOpportunity : opportunityNames) {
			    if (newOpportunity.getText().equals("Salesforce Automation by Your Selvi")) {
			...
			if (newOpportunityNameCreated) {
			    System.out.println(" The 'Salesforce Automation by Your Selvi' opportunity was created successfully.");
			} else {
